...
public class Application {
    public static void main(String[] args) {
        ...
        resto2.notifyOrder(order1);

        // Commande test 3
        Order order3 = resto3.prepareOrder(3,resto3.getName(), new Dish("Kebab", Dish.Size.L), 6, 51, "10 rue des génies, 13001 Marseille");
        resto3.notifyOrder(order3);
